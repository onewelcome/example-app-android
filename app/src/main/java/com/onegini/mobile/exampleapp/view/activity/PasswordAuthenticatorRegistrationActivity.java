...
public class PasswordAuthenticatorRegistrationActivity extends PasswordAuthenticatorActivity {

  @Override
  protected void onSuccess(final String password) {
    if (PasswordCustomAuthRegistrationAction.CALLBACK != null) {
      PasswordCustomAuthRegistrationAction.CALLBACK.acceptRegistrationRequest(password);
    }
  }
