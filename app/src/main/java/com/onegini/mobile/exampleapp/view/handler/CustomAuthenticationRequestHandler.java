...
import com.onegini.mobile.exampleapp.view.activity.BasicCustomAuthActivity;
import com.onegini.mobile.exampleapp.view.activity.PasswordCustomAuthActivity;
...
public class CustomAuthenticationRequestHandler implements OneginiCustomAuthenticationRequestHandler {
  ...
  public CustomAuthenticationRequestHandler(final Context context) {
    this.context = context;
  }

  @Override
  public void startAuthentication(final UserProfile userProfile, final String authenticatorId, final OneginiCustomCallback oneginiCustomCallback) {
  ...
  private Intent createIntent(final String authenticatorId) throws Exception {
    switch (authenticatorId) {
      case BASIC_CUSTOM_AUTHENTICATOR_ID:
        return new Intent(context, BasicCustomAuthActivity.class);
      case PASSWORD_CUSTOM_AUTHENTICATOR_ID:
        return new Intent(context, PasswordCustomAuthActivity.class);
      default:
