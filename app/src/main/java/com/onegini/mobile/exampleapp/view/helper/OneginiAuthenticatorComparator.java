...
public class OneginiAuthenticatorComparator implements Comparator<OneginiAuthenticator> {
  ...
  private int compareByType(final OneginiAuthenticator.Type o1, final OneginiAuthenticator.Type o2) {
    if (o1 == o2) {
      return 0;
    }

    // o1 == PIN && o2 == BIOMETRIC || CUSTOM
    if (o1 == OneginiAuthenticator.Type.PIN) {
      return -1;
    }

    // o2 == PIN && o1 == BIOMETRIC || CUSTOM
    if (o2 == OneginiAuthenticator.Type.PIN) {
      return 1;
    }

    // o1 == BIOMETRIC && o2 == CUSTOM
    if (o1 == OneginiAuthenticator.Type.BIOMETRIC) {
      return -1;
    }
