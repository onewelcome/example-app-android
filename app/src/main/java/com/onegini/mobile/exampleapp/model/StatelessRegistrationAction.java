...
public class StatelessRegistrationAction implements OneginiCustomTwoStepRegistrationAction {
  ...
  @Override
  public void initRegistration(@NonNull OneginiCustomRegistrationCallback registrationCallback, @Nullable CustomInfo customInfo) {
    registrationCallback.returnSuccess("success");
  }
}
